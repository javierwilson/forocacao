...
from .models import Event, Activity, Profession, Invited, Attendee, AttendeeType, AttendeePayment, PaymentMethod, EventBadge, Font, AttendeeReceipt, Content, Field, News, Logo, Organization, Question, Topic
...
def mail_attendee(modeladmin, request, queryset):
    if has_approval_permission(request):
        ...
        for obj in queryset:
            ...
            # FIXME: no event title in email message?
